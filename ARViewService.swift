...
//        await wallAnchor.removeChild(selectedEntity)
...
//        guard let frameModel = await modelEntity.model else { return }
//
...
//        await cancellable = ModelEntity.loadModelAsync(contentsOf: frameURL)
